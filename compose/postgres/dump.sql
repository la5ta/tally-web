...
84c8af80-f709-4acc-8b77-b23b1173f87d	2020-07-18 20:12:09.751067+00	{"metadata":false,"remote_schemas":[]}
\.
...
public	orders	{"custom_root_fields": {}, "custom_column_names": {}}	f	f
public	products	{"custom_root_fields": {}, "custom_column_names": {}}	f	f
public	carts	{"custom_root_fields": {}, "custom_column_names": {}}	f	f
public	order_item	{"custom_root_fields": {}, "custom_column_names": {}}	f	f
\.
...
b6b7e5da-baea-4bf1-af3b-75810a44da86	36	2020-07-18 18:50:32.916048+00	{}	{"telemetryNotificationShown": true}
\.
...
COPY public.carts (id, created_at, updated_at, user_id, product_id) FROM stdin;
\.
...
COPY public.order_item (id, created_at, updated_at, product_id, user_id, order_id, price) FROM stdin;
3cd90e03-053f-433b-98c6-64274f806bcf	2020-07-18 19:24:34.553684+00	2020-07-18 19:24:34.553684+00	66078b24-d4d8-4618-89fe-13327aeb4f14	039da040-0dfa-4a89-bf94-32abe72479c6	b91e7bdf-feac-4f44-8f3e-06ba510e332b	299
\.
...
COPY public.orders (id, created_at, updated_at, address, user_id) FROM stdin;
b91e7bdf-feac-4f44-8f3e-06ba510e332b	2020-07-18 19:23:35.972399+00	2020-07-18 19:23:35.972399+00	Amsterdam	039da040-0dfa-4a89-bf94-32abe72479c6
\.
...
COPY public.products (id, created_at, updated_at, name, price, stock_avilable) FROM stdin;
214f7887-a727-4a78-8f37-fc566aaafc90	2020-07-18 19:21:19.233742+00	2020-07-18 19:21:19.233742+00	iPhone 11	1000	10
a15826d2-96fb-4302-8e4a-c43cbf61fa46	2020-07-18 19:21:38.873442+00	2020-07-18 19:21:38.873442+00	PS4	400	40
66078b24-d4d8-4618-89fe-13327aeb4f14	2020-07-18 19:22:08.527954+00	2020-07-18 19:22:08.527954+00	Nintendo Switch	299	50
\.
...
COPY public.users (id, created_at, updated_at, name, email) FROM stdin;
039da040-0dfa-4a89-bf94-32abe72479c6	2020-07-18 19:20:37.236005+00	2020-07-18 19:20:37.236005+00	Luis	luis@tally.com
44a0a6f5-76d5-44ac-9bc4-bf8863de8806	2020-07-18 19:20:44.338987+00	2020-07-18 19:20:44.338987+00	Nini	nini@tally.com
6f5303d0-a067-4e53-b5c4-e7ca50287900	2020-07-18 19:20:53.337275+00	2020-07-18 19:20:53.337275+00	Mary	mary@tally.com
\.
...
--
-- Name: carts set_public_carts_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: TRIGGER set_public_carts_updated_at ON carts; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: order_item set_public_order_item_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: TRIGGER set_public_order_item_updated_at ON order_item; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: orders set_public_orders_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: TRIGGER set_public_orders_updated_at ON orders; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: order_item order_item_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
